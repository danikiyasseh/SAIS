...
def getNewVUAVids():
    return ['P-102 VUA (Log_D2P280355_2017.06.13_22.03.37)',
             'P-104 VUA (Log_D2P280355_2017.06.21_13.36.23)',
             'P-124 VUA (Log_D2P280355_2017.09.19_07.43.13)',
             'P-135 VUA (Log_D2P280778_2017.09.20_23.14.14)',
             'P-158 VUA (Log_D2P280355_2017.12.07_09.01.30)',
             'P-163 VUA (Log_D2P280792_2018.02.20_08.37.44)',
             'P-179 VUA (Log_D2P282641_2018.06.18_08.04.18)',
             'P-183 VUA (Log_D2P280792_2018.07.16_10.26.39)',
             'P-198 VUA (Log_D2P280404_2018.05.03_12.39.03)',
             'P-200 VUA (Log_D2P280792_2018.05.22_16.49.13)',
             'P-202 VUA (Log_D2P280404_2018.02.16_09.22.32)',
             'P-205 VUA (Log_D2P280792_2018.02.26_09.48.34)',
             'P-207 VUA (Log_D2P280792_2018.02.26_09.48.34)',
             'P-208 VUA (Log_D2P280792_2018.02.28_12.30.37)',
             'P-255 VUA (Log_D2P280355_2018.04.04_07.48.12)',
             'P-292 VUA (Log_D2P280778_2018.09.14_14.46.46)',
             'P-311 VUA (Log_D2P280778_2018.10.29_08.48.21)',
             'P-328 VUA (Log_D2P280778_2018.11.08_11.34.32)',
             'P-338 VUA (Log_D2P280778_2018.12.14_14.04.34)',
             'P-358 VUA (Log_D2P280400_2019.01.09_07.56.17)',
             'P-369 VUA (Log_D2P281044_2019.03.08_09.06.18)',
             'P-370 VUA (Log_D2P281044_2019.03.08_09.06.18)',
             'P-372 VUA (Log_D2P281044_2019.03.13_08.42.24)',
             'P-384 VUA (Log_D2P281044_2019.04.17_13.26.00)',
             'P-386 VUA (Log_D2P281044_2019.04.15_12.47.22)',
             'P-388 VUA (Log_D2P281044_2019.04.12_08.59.52)',
             'P-392 VUA (SESSION_GSD7188119_20190424T134337)',
             'P-400 VUA (SESSION_GSD7188119_20190410T081524)',
             'P-402 VUA (SESSION_GSD7188119_20190403T084825)',
             'P-412 VUA (Log_D2P281044_2019.04.26_08.57.46)',
             'P-413 VUA (Log_D2P281044_2019.04.26_13.03.35)',
             'P-421 VUA (Log_D2P281044_2019.05.14_12.56.06)']
...
class SurgDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,phases,args,train_fraction,dataset_list,transform='',extract_only=False):
        ...
        for dataset in dataset_list:
            ...
            if args.optical_flow_to_reps == True: #load optical flow paths
                curr_df = pd.read_csv(os.path.join(data_path,'SurgicalPaths','%s_FlowPaths.csv' % dataset),index_col=0)
                print('Loaded Optical Flow Paths!')
                #curr_df = curr_df.sample(n=10000,replace=False)
            elif args.segmentation_to_reps == True:
                curr_df = pd.read_csv(os.path.join(data_path,'SurgicalPaths','%s_SegPaths.csv' % dataset),index_col=0)    
                print('Loaded Segmentation Paths!')
            else: #load RGB paths
                curr_df = pd.read_csv(os.path.join(data_path,'SurgicalPaths','%s_Paths.csv' % dataset),index_col=0)
    ...
    def __getitem__(self,idx):
        ...
        if dataset in ['VUA_HMH','VUA_AFB']:
            data_path = '/mnt/md3/kiyasseh/SurgicalDatasets' # just because I have HMH data saved in a different directory
        else:
            data_path = '/mnt/md2/kiyasseh/SurgicalDatasets' # md2
